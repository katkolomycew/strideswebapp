      ...
      <Card id="privacy_wrapper" className="transparent">
        <Card.Body>
          <Card.Text id="privacy_wrapper-text">
            ...
            it's a bunch of poses to work on strength, breathing, and
            meditation.
            <br />
            ...
            <br />
            <br />
            <strong>Walking</strong> can be a stroll through the park or a hike
            up a mountain. The difference from running is that one foot is
            ...
            <br />
            <br />
            <strong>Swimming</strong>, whether backstroke, freestyle, or
            butterfly is sure to be a splash.
            <br />
            <span className="italics" style={{ marginLeft: "6.9rem" }}>
            ...
            football, soccer, badminton, laser tag, or whatever sport tickles
            your fancy.
            <br />
            <span className="italics" style={{ marginLeft: "6.9rem" }}>
            ...
            painting a wall. Anything where you're having to move around the
            house counts.
            <br />
            <span className="italics" style={{ marginLeft: "6.9rem" }}>
              No special access required
            ...
            sit-ups, pull-ups, (insert movement)-ups. Essentially, it's using
            your muscles without any equipment.
            <br />
            <span className="italics" style={{ marginLeft: "6.9rem" }}>
              No special access required
            </span>
