    ...
    <div className="community_wrapper">
      ...
      <div className="success-messages_wrapper">
        ...
        <Card body className="success-message_left">
          I went from not being able to get out of bed... to getting up to doing
          the dishes... to walking out to get the mail... to walking the
          block... to signing up for my first 5k yesterday! It's all about baby
          steps people!
        </Card>
      </div>
    </div>
