      ...
      <Card id="privacy_wrapper" className="transparent">
        <Card.Body>
          <Card.Text id="privacy_wrapper-text">
            ...
            <br />
            In short, you can do whatever kind of movement you enjoy! Our
            program includes 10 categories of activtities. Read more{" "}
            ...
            <br />
            Start by selecting the device you want to use in your Strides
            Account Details. Then you'll be prompted to give Strides access in
            your settings.
            <br />
            <br />
            ...
            you've given Strides permission to access the data. If that is
            turned on, you may have to open the devices app or wait for data
            from your device to be added to the cloud before it loads in
            Strides.
            <br />
            <br />
            <strong>How do I use the mood scale?</strong>
            <br />
            We want you to make the scale your own. What mood do you attribute
            to each number in the scale? To give you a starting idea, check out
            our description{" "}
