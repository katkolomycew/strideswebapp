    ...
    <Card id="privacy_wrapper">
      <Card.Body>
        <Card.Text id="privacy_wrapper-text">
          ...
          software, which help us safeguard all the information we collect
          online.
          <br />
          <br />
          ...
          share your information with us, feel free to contact us via email and
          we will be more than happy to change this for you.
          <br />
          <br />
